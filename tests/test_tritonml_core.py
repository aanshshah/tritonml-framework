...
class TestTritonModel:
    ...
    def test_detect_task(self):
        ...
        assert TritonModel._detect_task("cardiffnlp/twitter-roberta-base-emotion") == "text-classification"
        assert TritonModel._detect_task("bert-base-uncased") == "text-classification"
        assert TritonModel._detect_task("google/vit-base-patch16-224") == "image-classification"
