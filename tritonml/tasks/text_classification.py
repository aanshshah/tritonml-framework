...
class EmotionClassifier(TextClassificationModel):
    ...
    @classmethod
    def from_pretrained(cls, model_name_or_path: str = "cardiffnlp/twitter-roberta-base-emotion", **kwargs) -> "EmotionClassifier":
...
class SentimentClassifier(TextClassificationModel):
    ...
    @classmethod
    def from_pretrained(cls, model_name_or_path: str = "distilbert-base-uncased-finetuned-sst-2-english", **kwargs) -> "SentimentClassifier":
