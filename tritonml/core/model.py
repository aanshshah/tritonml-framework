...
class TritonModel(ABC):
    ...
    @classmethod
    def from_huggingface(cls, model_id: str, task: Optional[str] = None, **kwargs) -> "TritonModel":
    ...
    def optimize(self, optimization_config: Optional[Dict[str, Any]] = None) -> "TritonModel":
    ...
    def benchmark(self, test_inputs: List[Any], batch_sizes: List[int] = [1, 8, 16, 32]) -> Dict[str, Any]:
