...
class TritonClient:
    ...
    def prepare_inputs(self, inputs: Dict[str, np.ndarray]) -> List[httpclient.InferInput]:
    ...
    def prepare_outputs(self, output_names: Optional[List[str]] = None) -> List[httpclient.InferRequestedOutput]:
