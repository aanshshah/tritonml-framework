...
class HuggingFaceDatasetLoader:
    ...
    def __init__(self, dataset_name: str, split: str = "test", config_name: Optional[str] = None):
    ...
    def get_samples(self, 
                   ...
                   batch_size: Optional[int] = None) -> Union[List[str], List[Dict[str, Any]]]:
        ...
        if text_column is None:
            text_columns = ["text", "sentence", "sentence1", "premise", "question", 
            ...
            if text_column is None:
                raise ValueError(f"Could not auto-detect text column. "
